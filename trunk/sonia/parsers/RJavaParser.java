 ...
 * input should be deparse("myNetwork", control=NULL);
...
E, multiple = FALSE, bipartite = FALSE)
	...
	/**
	 * creates edges corresponding to elements in mel
	 * mel = list(list(inl = 1, outl = 4, atl = list(na = FALSE)), list(inl = 1, outl = 5, atl = list(na = FALSE)), list(inl = 2, outl = 3, atl = list(na = FALSE)), list(inl = 2, outl = 4, atl = list(na = FALSE)), list(inl = 3, outl = 1, atl = list(na = FALSE)), list(inl = 3, outl = 4, atl = list(na = FALSE)), list(inl = 4, outl = 1, atl = list(na = FALSE)), list(inl = 4, outl = 2, atl = list(na = FALSE)), list(inl = 4, outl = 3, atl = list(na = FALSE)), list(inl = 4, outl = 5, atl = list(na = FALSE)), list(inl = 5, "
	...
	/**
	 * parses the list of vertex attributes and creates nodes with appropriates values
	 * "list(list(na = FALSE), list(na = FALSE), list(na = FALSE), list(na = FALSE), list(na = FALSE))"  * @param val
	 * @throws Exception
	 */
...
//				TODO: figure out how to map rest of attributes...
			...
			NodeAttribute node = new NodeAttribute(nodeId);
			nodeList.add(node);
			nodeId++;
		}
