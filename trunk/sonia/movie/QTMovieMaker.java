...
public class QTMovieMaker implements MovieMaker {
	...
	private String quality = "High"; // string for current quality
	...
	public void setupMovie(SoniaCanvas canvas, int frames) throws Exception {
		...
		seq = new CSequence(graphics, bounds, graphics.getPixMap()
				.getPixelSize(), codecType, CodecComponent.bestFidelityCodec,
	...
	public void finishMovie() {
		try {
			...
			movie.addResource(omf, StdQTConstants.movieInDataForkResID, movFile
					.getName());
