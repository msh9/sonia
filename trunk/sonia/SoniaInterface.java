 ...
 * Message window is used to provide updates on ongoing processes or errors.
 * Buttons are as follows:
 * <P>
 * Load Files.. - Brings up an open file dialog for chosing input file, uses
 * .net or .son parser depending on file extension
 * </P><P>
 * Create Layout.. Makes a new layout window, and brings up the LayoutSettingsDialog
 * for specifing bining etc.
 * </P><P>
...
public class SoniaInterface extends Frame implements WindowListener, ActionListener
    // ItemListener
{
  ...
  public SoniaInterface(SoniaController theController)
  {
    ...
    //buttons
    c.gridx=0;c.gridy=0;c.gridwidth=4;c.gridheight=1;c.weightx=0.1;c.weighty=0.1;
    add(StatusText,c);
    ...
    add(LayoutButton,c);
    c.gridx=2;c.gridy=1;c.gridwidth=1;c.gridheight=1;c.weightx=0.1;c.weighty=0.1;
    add(PauseButton,c);
    c.gridx=0;c.gridy=2;c.gridwidth=1;c.gridheight=1;c.weightx=0.1;c.weighty=0.1;
    add(MovieButton,c);
    c.gridx=1;c.gridy=2;c.gridwidth=1;c.gridheight=1;c.weightx=0.1;c.weighty=0.1;
    add(SaveButton,c);
    c.gridx=0;c.gridy=3;c.gridwidth=4;c.gridheight=1;c.weightx=0.1;c.weighty=0.1;
    add(Credits,c);
...
/**
 ...
 {
   FileDialog locateOutput = new FileDialog(this,
...
{
 FileDialog locateInput = new FileDialog(this,
   message, FileDialog.LOAD);
 //throw up open dialog
