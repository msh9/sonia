/* THIS CLASS IS BSD LICENSED FROM THE PREFUSE PACKAGE
 */
package sonia;
 ...
 * for computing bounds and performing optimized drawing. This class has been 
 * copied from the Prefuse interactive visualization toolkit http://prefuse.org 
...
public class GeomUtils {
     ...
     */
    private static boolean isNonLeft(int i0, int i1, int i2, int i3, float[] pts) {
     ...
     */
    public static void growPolygon(float pts[], float amt) {
            ...
            float slack, boolean closed, float tx, float ty)
    {
        ...
        if ( len < 6 ) {
            ...
            //TODO: if only two points, make an elipse
        }
        //start from first point
        p.moveTo(pts[0]+tx,pts[1]+ty);
